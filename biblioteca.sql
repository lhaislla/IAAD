...
insert into LIVRO values
    ...
    ('0909918','Sistemas de Banco de Dados','Marvin'),
    ('0159178', 'design thinking business','Pearson');
insert into LIVRO_AUTOR values
    ...
    ('0909918','Elmasri Navathe'),
    ('0159178','Maurício Vianna');
insert into EDITORA values
    ...
    ('Marvin', 'Rua Otaviano Costa, 42, Recife, PE',987345876),
    ('Pearson','Rua Otaviano Costa, 42, Recife, PE',991875469);
...
insert into LIVRO_EMPRESTIMO values
    ...
    ('0909918','PPPL5',200048888,'2020-08-01','2020-09-01'),
    ('0159178','JKTV6',300057777,'2020-08-05','2020-08-15');
insert into UNIDADE_BIBLIOTECA values
    ...
    ('PPPL5','Sede_UFRPE' ,'Rua Otaviano Costa, 42, Recife, PE'),
    ('JKTV6','Sede_UFRPE','Rua Otaviano Costa, 42, Recife, PE');
insert into USUARIO values
	(123456789,'Amaro Camargo Ferreira', 'Rua Coelho Rodrigues, 1175, Teresina, PI',993931313),
    ...
    (200048888,'Ana Carolina Ramirez', 'Rua Margaridas das Flores, 14, João Pessoa, PB',987653211),
    (300057777,'Alice dos Anjos','Rua dos Tamarinos, 71, Carpina,PE', 997145467);
...
-- Respostas da atividade, estão como comentário para que não se misturem os retornos de consulta das tabelas: 
